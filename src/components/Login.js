        ...
        <div className='bg-blue-500 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center'>
            <div className='md:w-1/2 px-10'>
                ...
                <form className='flex flex-col gap-4' onSubmit={handleLoginSubmit}>
                    ...
                    <button className="bg-[#002D74] text-white rounded-xl py-2 hover:scale-105 duration-300" type="submit">Login</button>
                </form>
                ...
                <div className='mt-3 text-xs flex justify-between items-center'>
                    ...
                    <button className="py-2 px-5 bg-white border rounded-xl hover:scale-105 duration-300"><Link to="/signin">Register</Link></button>
                </div>
            </div>
